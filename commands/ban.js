...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let channel = client.guilds.cache.get(client.config.guildID).channels.cache.find(c => c.name === "ban-kick-log") //log kanalının ismi
        ...
        message.channel.send(embed.setDescription(`${member} adlı kullanıcı ${message.author} tarafından **${reason}** sebebiyle sunucudan yasaklandı!`).setImage('https://tenor.com/view/megumin-konosuba-explosion-meledak-ledakan-gif-12327270')).then(x => x.delete({ timeout: 5000 }))
